...
export default function SettingsModal({ t, acc, theme, movieColor, bookColor, onTheme, onAccent, onTypeColor, onClose }) {
  const overlay = { position: 'fixed', inset: 0, background: 'rgba(0,0,0,.62)', zIndex: 200 }
  const box = {
      ...
      <div style={box}>
            ...
            {ACC_LIST.map((a, i) => (
              <div
                ...
                style={{
                  ...
                  outline: a.c === acc.c ? `3px solid ${t.text}` : 'none',
        ...
        <div style={{ marginBottom: 22 }}>
          ...
          <div style={{ display: 'flex', gap: 16 }}>
            {[['영화', 'movie', movieColor], ['책', 'book', bookColor]].map(([label, key, val]) => (
